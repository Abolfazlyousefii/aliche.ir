...
<aside class="admin-sidebar" id="adminSidebar" aria-label="منوی مدیریت">
    ...
    <nav class="admin-sidebar-nav">
        <?php $__currentLoopData = $adminMenuGroups; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <?php
            ...
            ?>
            <?php if(! $canSeeParent && $children->isEmpty()) continue; ?>
            <?php if($children->isEmpty()): ?>
                <a class="admin-nav-link <?php echo e($isActive ? 'is-active' : ''); ?>" href="<?php echo e(route($item['route'], $item['params'] ?? [])); ?>" <?php if($isActive): ?> aria-current="page" <?php endif; ?>>
                    <span class="admin-nav-icon"><?php echo e($item['icon']); ?></span>
                    <span><?php echo e($item['title']); ?></span>
                    <?php if($badge > 0): ?><span class="badge bg-danger ms-auto"><?php echo e($badge); ?></span><?php endif; ?>
                </a>
            <?php else: ?>
                <details class="admin-nav-dropdown" <?php echo e($isActive ? 'open' : ''); ?>>
                    <summary class="admin-nav-link <?php echo e($isActive ? 'is-active' : ''); ?>">
                        <span class="admin-nav-icon"><?php echo e($item['icon']); ?></span>
                        <span><?php echo e($item['title']); ?></span>
                        <?php if($badge > 0): ?><span class="badge bg-danger ms-auto"><?php echo e($badge); ?></span><?php endif; ?>
                    ...
                    <div class="admin-nav-submenu">
                        <?php $__currentLoopData = $children; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $child): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            ?>
                            <a class="admin-nav-sublink <?php echo e($childActive ? 'is-active' : ''); ?>" href="<?php echo e(route($child['route'], $child['params'] ?? [])); ?>" <?php if($childActive): ?> aria-current="page" <?php endif; ?>>
                                <span><?php echo e($child['title']); ?></span>
                                <?php if($childBadge > 0): ?><span class="badge bg-danger ms-auto"><?php echo e($childBadge); ?></span><?php endif; ?>
                            </a>
...
<?php /**PATH /home/aliche/domains/aliche.ir/resources/views/admin/partials/sidebar.blade.php ENDPATH**/ ?>